...
/// The Object itself must conform to Serializable (or SerializableEncodable / SerializableDecodable)
/// Default value is by default nil. Can be used directly without arguments
public final class SerializedEncodable<T> {
    var key: String?
    var alternateKey: String?
...
/// The Object itself must conform to Serializable (or SerializableEncodable / SerializableDecodable)
/// Default value is by default nil. Can be used directly without arguments
public final class SerializedDecodable<T> {
    var key: String?
    var alternateKey: String?
...
/// Encodable support
extension SerializedEncodable: EncodableProperty where T: Encodable {
...
/// Decodable support
extension SerializedDecodable: DecodableProperty where T: Decodable {
